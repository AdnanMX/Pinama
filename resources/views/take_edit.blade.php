...
<section class="content">
  ...
  <div>
    <div class="card-header">
      <h3 class="card-title">Edit Data Pengambilan</h3>

    </div>
    <div class="card-body">
      <a href="{{ route('take.index') }}" class="btn btn-secondary">Kembali</a>
      <br><br>

      <form action="{{ route('take.update', $take->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
